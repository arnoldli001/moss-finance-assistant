...
ZSXQ_SEARCH_CARD_SCROLL_INTO_VIEW_TIMEOUT_MS: float = 2000

# 搜索结果卡片滚动进入视口后的额外等待秒数
ZSXQ_SEARCH_CARD_AFTER_SCROLL_WAIT_SEC: float = 0.3

# 点击搜索结果卡片的超时（毫秒）
ZSXQ_SEARCH_CARD_CLICK_TIMEOUT_MS: float = 2000

# 搜索结果卡片内部 fallback 点击超时（毫秒）
ZSXQ_SEARCH_CARD_INNER_CLICK_TIMEOUT_MS: float = 2000
...
ZSXQ_SEARCH_DETAIL_TEXT_INNER_TIMEOUT_MS: float = 2000
